...
<html>
  ...
  <body>
    ...
    <div>
     <form name="serch" method="get" action="/userSerch">
      <input type="hidden" name="serchPageLimit" value="{{$pageView['pageLimit']}}" />
      <table class="table">
        ...
        <tbody >
          <tr>
            ...
            <td>
              ...
              <input type="text" id="serchFirWord" name="serchFirWord" />
            </td>
          </tr>
          <tr>
            <td>
              ...
              <input type="text" id="serchSecWord" name="serchSecWord" />
            </td>
          </tr>
          <tr>
            <td>상태</td>
              <td>
                <input id="serchUserAll" name="serchUserAll" value="%" type="checkbox" checked> 모든계정
                <input id="serchUserActive" name="serchUserActive" value="가입" type="checkbox"> 사용계정
                <input id="serchUserSleep" name="serchUserSleep" value="휴면" type="checkbox"> 휴먼계정
              </td>
          </tr>
          <tr>
            <td>성별</td>
          ...
          <tr>
            <td>가입일</td>
            <td>
              <input type="date" id="serchDateFir" name="serchDateFir" value="2000-01-01" />
              <input type="date" id="serchDateSec" name="serchDateSec" value="2050-01-01"/>
            </td>
          </tr>
          <tr>
            <td>정렬</td>
